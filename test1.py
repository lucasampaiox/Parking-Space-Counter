...
cap=cv2.VideoCapture('data/easy1.mp4')
...
#        print(row)
    ...
    for i, polyline in enumerate(polylines):
        ...
        cvzone.putTextRect(frame, f'{area_names[i]}', (polyline[0]), 1, 1)
        for i1 in list1:
            cx1 = i1[0]
            cy1 = i1[1]
    ...
    cvzone.putTextRect(frame, f'FREE SPACE: {free_space}', (50, 150), 2, 2)
